<?php 
/**
 * MP Stacks Template Music
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template Music
 ...
 */
	 ...
	 /**
	 * Add Music to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_echo_music
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_echo_music( $installed_templates ){ 
		
		$installed_templates['mp_stacks_echo_music_array'] = array(
			'template_slug' => 'echo_music',
			'template_title' => __( 'Music', 'echo_band_theme_bundle' ),
			'template_description' => __('Created using: Echo Band Theme Bundle\'s "Music" Stack', 'echo_band_theme_bundle' ),
			'template_tags' => 'Music, Band',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'https://demo.mintplugins.com/echo/music/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_echo_music' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_echo_music_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_echo_music_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['echo_music'] = array( 'title' => 'Music','add_to_primary_menu' => 'true', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'echo_band_theme_bundle_default_stacks', 'mp_stacks_templates_echo_music_to_default_stacks' );
	
	/**
	 * This function holds and returns the Music Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_echo_music_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Echo Band Theme Bundle\'s "Music" Stack',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            'linkgrid_link_url' => 
            array (
              'value' => 'https://demo.mintplugins.com/echo/recollection/',
              'attachment' => false,
            ),
            ...
            'linkgrid_link_image' => 
            array (
              'value' => 'http://demo.mintplugins.com/echo/wp-content/uploads/sites/18/2016/05/ALBUMCOVER.jpg',
              'attachment' => false,
            ),
            'linkgrid_link_title' => 
            array (
          ...
          array (
            'linkgrid_link_url' => 
            array (
              'value' => 'https://demo.mintplugins.com/echo/forests-and-fields/',
              'attachment' => false,
            ),
            'linkgrid_link_open_type' => 
            array (
          ...
          array (
            'linkgrid_link_url' => 
            array (
              'value' => 'https://demo.mintplugins.com/echo/owls-nest/',
              'attachment' => false,
            ),
            'linkgrid_link_open_type' => 
            array (
            ...
            'linkgrid_link_image' => 
            array (
              'value' => 'http://demo.mintplugins.com/echo/wp-content/uploads/sites/18/2016/05/Albumcover2.jpg',
              'attachment' => false,
            ),
            'linkgrid_link_title' => 
            array (
