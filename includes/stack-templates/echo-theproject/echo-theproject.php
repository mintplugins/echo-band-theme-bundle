<?php 
/**
 * MP Stacks Template The Project
 *
 * @link http://mintplugins.com/doc/
 * @since 1.0.0
 *
 * @package     MP Stacks Template The Project
 ...
 */
	 ...
	 /**
	 * Add The Project to the list of installed stack templates
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp_stacks_templates_add_echo_theproject
	 * @see      function_name()
	 * @param    array $installed_templates See link for description.
	 * @return   array $installed_templates See link for description.
	 */
	function mp_stacks_templates_add_echo_theproject( $installed_templates ){ 
		
		$installed_templates['mp_stacks_echo_theproject_array'] = array(
			'template_slug' => 'echo_theproject',
			'template_title' => __( 'The Project', 'echo_band_theme_bundle' ),
			'template_description' => __('Created using: Echo Band Theme Bundle\'s "The Project" Stack', 'echo_band_theme_bundle' ),
			'template_tags' => 'Project, Echo',
			'template_preview_img' => plugins_url( '/images/preview_thumbnail.jpg', __FILE__ ),
			'template_demo_url' => 'https://demo.mintplugins.com/echo/the-project/',
		);
		
		return $installed_templates;
	
	}
	add_filter( 'mp_stacks_installed_templates', 'mp_stacks_templates_add_echo_theproject' );
	
	/**
	 * Add This Stack Template to the list of Default Stacks to create when the parent Theme Bundle is activated.
	 *
	 * @since    1.0.0
	 * @link     https://mintplugins.com/doc/mp_stacks_templates_echo_theproject_to_default_stacks
	 * @see      function_name()
	 ...
	 */
	function mp_stacks_templates_echo_theproject_to_default_stacks( $default_stacks_to_create ){ 
				
		$default_stacks_to_create['page']['echo_theproject'] = array( 'title' => 'The Project','add_to_primary_menu' => 'true', );
		
		return $default_stacks_to_create;
	
	}
	add_filter( 'echo_band_theme_bundle_default_stacks', 'mp_stacks_templates_echo_theproject_to_default_stacks' );
	
	/**
	 * This function holds and returns the The Project Template Array
	 *
	 * @since    1.0.0
	 * @link     http://mintplugins.com/doc/mp-stacks-stack-template-function
	 * @return   array The Stack Template Aray
	 */
	function mp_stacks_echo_theproject_array(){ 
	
		$template_array = array (
  'stack_title' => '',
  'stack_description' => 'Created using: Created using: Echo Band Theme Bundle\'s "The Project" Stack',
  'stack_bricks' => 
  array (
    'brick_1' => 
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'brick_text' => 
            array (
              'value' => '&lt;p style=&quot;text-align: left;&quot;&gt;GREETINGS FRIENDS,&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            array (
              'value' => '&lt;hr /&gt;
&lt;p style=&quot;text-align: center;&quot;&gt;&quot;Another profound quote.&quot;&lt;/p&gt;
&lt;hr /&gt;
...
&lt;p style=&quot;text-align: left;&quot;&gt;Hope you enjoy our new project!&lt;/p&gt;
&lt;p style=&quot;text-align: left;&quot;&gt;Cheers,&lt;/p&gt;
&lt;p style=&quot;text-align: left;&quot;&gt;The Band&lt;/p&gt;
',
              'attachment' => false,
            ),
          ),
